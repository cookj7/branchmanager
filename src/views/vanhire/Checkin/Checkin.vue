<template>
    <div class="animated fadeIn">
        <b-row>
            <b-col>
                <b-card header="Awaiting Check-in" class="card-accent-warning">
                    <p>
                        Below are listed the van hire bookings that are checked out and awaiting check-in.<br>
        ...
        <b-row>
            <b-col>
                <b-card header="Checked-in" class="card-accent-success">
                    <p>
                        Below are listed the van hire bookings that are currently checked-in.<br>
                        Click on an item to view/edit check-in details.
                    </p>
                    <b-table hover striped
                             :items="findActive"
...
<script src="./Checkin.vue.js"></script>
