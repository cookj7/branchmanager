                ...
                <b-col>
                    <b-card class="card-accent-primary">
                        ...
                        <b-form-group
                                ...
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="fullName" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                ...
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="address1" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                ...
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="address2" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                ...
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="address3" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                label="Town/City"
                                label-for="address4"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="address4" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                label="Postcode"
                                label-for="postcode"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="postcode" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                label="Date of birth"
                                label-for="dob"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="dob" type="text"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                ...
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input plaintext id="license" type="text"></b-form-input>
                        </b-form-group>
                    </b-card>
                </b-col>
            </b-row>
                ...
                <b-col>
                    <b-card class="card-accent-success">
                        ...
                        <b-form-group
                                ...
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="driverLicense"
                                                :plain="true"
                        ...
                        <b-form-group
                                ...
                                label-for="leavingVehicle"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="leavingVehicle"
                                                :plain="true"
                                                :options="yesNoOptions"
                                                :checked="0">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                            ...
                            <b-input-group>
                                ...
                                <b-form-input id="depositPaid" type="text" placeholder="ex. £250.00"></b-form-input>
                        ...
                        <b-form-group
                                ...
                                label-for="timeCheckout"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-select id="timeCheckout"
                                           :plain="true"
                        ...
                        <b-form-group
                                ...
                                label="Return time"
                                label-for="timeCheckin"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-select id="timeCheckin"
                                           :plain="true"
                                           :options="getTimeOptions()"
                                           value="Please select">
                            </b-form-select>
                ...
                <b-col>
                    <b-card class="card-accent-warning">
                        ...
                        <b-form-group
                                ...
                                label-for="conditionBodywork"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input id="conditionBodywork" :textarea="true" :rows="9" placeholder="Enter details of any issues"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                description="This should include notes on the windscreen wiper blades"
                                label="Condition of wiper blades"
                                label-for="conditionWiper"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input id="conditionWiper" :textarea="true" :rows="9" placeholder="Enter details of any issues"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                ...
                                label-for="conditionWindscreen"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input id="conditionWindscreen" :textarea="true" :rows="9" placeholder="Enter details of any issues"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                description="This should include notes on the condition of the tyres (including pressure and wear)"
                                label="Condition of tyres"
                                label-for="conditionTyres"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input id="conditionTyres" :textarea="true" :rows="9" placeholder="Enter details of any issues"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                ...
                                label-for="conditionJack"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input id="conditionJack" :textarea="true" :rows="9" placeholder="Enter details of any issues"></b-form-input>
                        </b-form-group>
                        <b-form-group
                                description="This should include notes on the functionality of the tail lift"
                                label="Condition of tail lift"
                                label-for="conditionTailLift"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-input id="conditionTailLift" :textarea="true" :rows="9" placeholder="Enter details of any issues"></b-form-input>
                        </b-form-group>
                    </b-card>
                </b-col>
            </b-row>
                ...
                <b-col>
                    <b-card class="card-accent-secondary">
                        ...
                        <b-form-group
                                ...
                                label="Coolant level"
                                label-for="levelCoolant"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="levelCoolant"
                                                :plain="true"
                                                :options="okOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label-for="levelWindscreenWash"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="levelWindscreenWash"
                                                :plain="true"
                                                :options="okOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label-for="levelBrake"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="levelBrake"
                                                :plain="true"
                                                :options="okOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label-for="levelPowerSteering"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="levelPowerSteering"
                                                :plain="true"
                                                :options="okOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label-for="levelBattery"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="levelBattery"
                                                :plain="true"
                                                :options="okOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label-for="leaksOilWater"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="leaksOilWater"
                                                :plain="true"
                                                :options="okOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label="Tool kit"
                                label-for="toolkitPresent"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="toolkitPresent"
                                                :plain="true"
                                                :options="yesNoOptions"
                                                :checked="1">
                            </b-form-radio-group>
                        ...
                        <b-form-group
                                ...
                                label="Sat Nav"
                                label-for="satNavPresent"
                                :label-cols="3"
                                :horizontal="true">
                            <b-form-radio-group id="satNavPresent"
                                                :plain="true"
                                                :options="yesNoOptions"
                                                :checked="1">
                            </b-form-radio-group>
